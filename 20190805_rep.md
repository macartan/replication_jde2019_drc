...
and can be sourced directly from the Dataverse server with the option
below (`local_data <- FALSE`) or locally from folder “Data”.

Supporting code can be found in folder “Code”. The code outputs tables
and figures into the folder “Output”, which are then sourced in from the
LaTeX file of the manuscript.
...
![](20190805_rep_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
![](20190805_rep_files/figure-gfm/unnamed-chunk-22-1.png)<!-- -->
